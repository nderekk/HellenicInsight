...
# print(MODEL)
MODEL="/bigono/work/true_fused_qwen_moe"  # hardcoded for now, can switch to env var if needed
MAX_WORKERS = 32       # parallel HTTP requests to vLLM
...
def call_vllm(article_text: str) -> str:
    payload = {
        ...
        "messages": [
            ...
            {"role": "assistant"}   # ← prefill forces JSON-first output
        ],
        "temperature": TEMPERATURE,
        "max_tokens": MAX_TOKENS,
        # "chat_template_kwargs": {"enable_thinking": True},
        "thinking": {                       # vLLM Qwen3 specific
            "type": "disabled",
            "budget_tokens": 512          # cap thinking at 1024, rest goes to output
        }
